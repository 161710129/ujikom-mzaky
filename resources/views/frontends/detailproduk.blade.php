...
<head>
    ...
    <!-- Title  -->
    <title>Karl | Product Details</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- ****** Header Area Start ****** -->
        <header class="header_area bg-img background-overlay-white" style="background-image: url(assets/frontend/img/bg-img/bg-1.jpg);">
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-9.jpg') }}" alt="First slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/product-2.jpg') }}">
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-2.jpg') }}" alt="Second slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/product-3.jpg') }}">
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-3.jpg') }}" alt="Third slide">
                                    </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="img/product-img/product-4.jpg') }}">
                                        <img class="d-block w-100" src="{{ asset ('assets/frontend/img/product-img/product-4.jpg') }}" alt="Fourth slide">
                                    </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single_gallery_item">
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-quicview">
                                        <a href="#" data-toggle="modal" data-target="#quickview{{$data->id}}"><i class="ti-plus"></i></a>
                                    </div>
                                </div>
                                <!-- Product Description -->
                                ...
                                </div>@include('frontends.modalproduk')
                            </div>@endforeach 
                        </div>                       
                    </div>
                    {{ $produks->links() }}
